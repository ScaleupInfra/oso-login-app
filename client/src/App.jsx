...
function App() {
  ...
  <article className="blog-card">
    ...
    <div className="blog-content">
      ...
      <span className="blog-meta">
        <img src="https://images.unsplash.com/photo-1607746882042-944635dfe10e?auto=format&fit=crop&w=100&q=80" alt="Chef Alex" className="user-avatar" />
  ...
  <article className="blog-card">
    ...
    <div className="blog-content">
      ...
      <span className="blog-meta">
        <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=100&q=80" alt="John Smith" className="user-avatar" />
        By John Smith · 5 hours ago
      </span>
    </div>
  </article>
  <article className="blog-card">
